        ...
        <div class="borrow-time">
          <yd-cell-group>
            <yd-cell-item arrow>
              ...
              <yd-datetime  ref="datetime" type="date" v-model="borrowdate" slot="right" :callback="confirmBorrow" :init-emit="false"></yd-datetime>
            </yd-cell-item>
          </yd-cell-group>
...
export default {
  ...
  methods: {
    ...
    getBook(param) {
      this.api.getBookList(Object.assign({page:this.currentPage},param)).then(res => {
    ...
    loadList() {
      if(this.currentPage <= this.lastPage){
        ++this.currentPage;
        this.api.getBookList({page:this.currentPage}).then(res => {
